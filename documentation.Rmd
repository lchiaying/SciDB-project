...
![A one-dimensinoal SciDB array holding 3 attributes each element](./firstPlot.png)

![A two-dimensinoal SciDB array holding 1 nullable attributes each element](./firstPlot.png)
