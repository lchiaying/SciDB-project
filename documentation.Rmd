...
![A one-dimensinoal SciDB array holding 3 attributes each element](./SciDB-project/blob/master/documentation_files/figure-docx/firstPlot.png)

![A two-dimensinoal SciDB array holding 1 nullable attributes each element](./SciDB-project/blob/master/documentation_files/figure-docx/firstPlot.png)
...
We also need the singular vectors. We'll get SciDB to compute and store the singular vectors, and then extract only the first 3 singular vectors into R for inspection.
